...
Reviewer paths are indexed in the [Technical Evidence Index](docs/technical-evidence-index.md), with machine-readable release receipts in [release evidence](docs/release-evidence-v0.1.0.json). The implementation is synthetic and clean-room reconstructed; see [PROVENANCE.md](PROVENANCE.md).
